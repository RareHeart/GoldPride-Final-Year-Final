...
namespace UserRoles.Controllers
{
    ...
    public class AccountController : ApplicationBaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Name = model.Name, Surname = model.Surname, PhoneNumber = model.PhoneNumber, MySignature = model.MySignature };
                var result = await UserManager.CreateAsync(user, model.Password);
                if (result.Succeeded)
                {
                    // Remove comment below to disable email confirmation before login
                    ...
                    ViewBag.Message = "Check your email and confirm your account, your account must be confirmed before you can log in";
